...
public class QuizDto {
    ...
    public QuizDto(String id, RoundDto currentRound, int score, int totalWrongAnswers, QuizStatus status) {
        this.id = id;
    ...
    public QuizDto(String id, int score, int totalWrongAnswers, QuizStatus status) {
        this.id = id;
        this.score = score;
        this.totalWrongAnswers = totalWrongAnswers;
        this.status = status;
    ...
    public static QuizDto fromQuiz(Quiz quiz) {
        ...
        if(currentRound != null) {
            ...
            return new QuizDto(quiz.getID().toString(), roundDto, quiz.getScore(), quiz.getTotalWrongAnswers(), quiz.getStatus());
        }

        return new QuizDto(quiz.getID().toString(), quiz.getScore(), quiz.getTotalWrongAnswers(), quiz.getStatus());
    }
